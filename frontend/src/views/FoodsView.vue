...
// The household's saved foods: search, add, edit in place, archive.
...
<template>
  <main class="mx-auto max-w-5xl space-y-4 px-4 py-6">
    <div class="flex flex-wrap items-center gap-3">
      <h1 class="text-xl font-semibold">Foods</h1>
      <input
        v-model="q"
        class="w-64"
    ...
    <div class="card overflow-x-auto">
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-if="adding" class="bg-accent-soft" data-testid="food-editor" @keydown.enter="save">
            <td class="px-2 py-1">
              <input
                v-model="form.name"
                class="w-full"
